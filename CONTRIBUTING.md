# Como contribuir com o Guia de Cordova
...
3. **Descrição de 1 linha** dizendo o que é e por que vale o clique. Se o recurso é pago, diga isso na própria descrição (ex.: "curso pago da Alura").
...
1. Faça um fork e crie uma branch a partir da `main` (ex.: `feat/novo-guia-migracao-capacitor`).
2. Edite o `README.md`.
